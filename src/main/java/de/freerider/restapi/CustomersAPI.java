 ...
 */
@RequestMapping("${app.api.endpoints.customers}") // endpoint for /customers resource collection
public interface CustomersAPI {
	...
	/*
	 * Spring REST Controller annotation: 		@PathVariable("id") @ApiParam(value = "Customer id", required = true) long id
	 */
	@RequestMapping(
	...
	//
	public ResponseEntity<?> deleteCustomer( @PathVariable("id") @ApiParam(value = "Customer id", required = true) long id );
